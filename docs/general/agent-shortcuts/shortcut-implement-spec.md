...
1. Review the spec (if spec is unclear ask for clarification on which spec to use).

2. Review @docs/general/agent-rules/ for relevant rules relevant to implementing this
